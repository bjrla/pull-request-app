...
import { DependencyComparisonComponent } from "./components/dependency-comparison/dependency-comparison.component";
...
export const routes: Routes = [
  ...
  { path: "dependencies", component: DependencyComparisonComponent },
